...
const StickyProjectDisplay = ({
  ...
  return (
    <div ref={scrollRef}>
      <div className="w-screen h-screen max-w-full sticky top-0 flex flex-col justify-center items-center px-12 pb-12 pt-32 overflow-x-hidden">
        ...
        <div className="grid grid-cols-6 grid-rows-3 w-full h-full absolute top-0 gap-8 items-center justify-center -z-10 select-none">
          <motion.div
